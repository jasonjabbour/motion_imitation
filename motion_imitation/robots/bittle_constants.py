...
#CHANGE continue changing from here on down
INIT_ABDUCTION_ANGLE = 0
INIT_HIP_ANGLE = 0.52
INIT_KNEE_ANGLE = 0.52
...
MOTOR_GROUP = collections.OrderedDict((
    (LEG_NAMES[0], JOINT_NAMES[0:2]),
    (LEG_NAMES[1], JOINT_NAMES[2:4]),
    (LEG_NAMES[2], JOINT_NAMES[4:6]),
    (LEG_NAMES[3], JOINT_NAMES[6:8]),
))
